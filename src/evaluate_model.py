    ...
    with Holistic() as holistic_model:
        ...
        while video.isOpened():
            ...
            if there_hand(results) or recording:
                ...
                if count_frame >= MIN_LENGTH_FRAMES + margin_frame:
                    ...
                    if res[np.argmax(res)] > threshold:
                        ...
                        # Solo insertar si sent no es None
                        if sent is not None:
            ...
            if not src:
                ...
                # Filtrar elementos None antes de usar join
                filtered_sentence = [word for word in sentence if word is not None]
                cv2.putText(frame, ' | '.join(filtered_sentence), FONT_POS, FONT, FONT_SIZE, (255, 255, 255))
